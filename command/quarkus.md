---
description: Load Quarkus skill and get contextual guidance for your task
---

Load the Quarkus skill and help with any Quarkus development task.
...
Based on task type, read from `references/<module>/`:
...
Apply Quarkus-specific patterns and APIs from references to complete the user's request.

### Step 6: Summarize

```
=== Quarkus Task Complete ===

Module(s): <modules used>
